    ...
    try {
        ...
        if (tempUser.username !== username) {
            ...
            if (user) {
                ...
                // we can give a toast notification maybe that the name already exists 
            }
        }
...
export const unfollowUser= async(req,res)=>{
    try {
        ...
        res.json({success:true,message:"You are no longer folowing this user"})
...
export const sendConnectionRequest=async(req,res)=>{
    try {
        ...
        // the user can send 20 connection request in 24 hour
        ...
        {
            return res.json({success:false,message:"You have reached the max limit to send the requests"})
        }
