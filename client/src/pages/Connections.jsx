                ...
                <div className="flex-1">
                  ...
                  <div className="flex gap-3 mt-2">
                    ...
                    {currentTab === 'Following' && (
                      <button className="px-3 py-1 text-sm bg-red-500 text-white rounded-full hover:bg-red-600 transition cursor-pointer">
                        Unfollow
                      </button>
                    )}
                    {currentTab === 'Pending' && (
                      <button className="px-3 py-1 text-sm bg-green-500 text-white rounded-full hover:bg-green-600 transition cursor-pointer">
                        Accept
                      </button>
                    )}
